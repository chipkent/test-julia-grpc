...
function meta(::Type{HelloRequest})
    ProtoBuf.metalock() do
        if !isassigned(__meta_HelloRequest)
            ...
            meta(target, HelloRequest, allflds, ProtoBuf.DEF_REQ, ProtoBuf.DEF_FNUM, ProtoBuf.DEF_VAL, ProtoBuf.DEF_PACK, ProtoBuf.DEF_WTYPES, ProtoBuf.DEF_ONEOFS, ProtoBuf.DEF_ONEOF_NAMES)
        end
        __meta_HelloRequest[]
    end
end
...
function meta(::Type{HelloReply})
    ProtoBuf.metalock() do
        if !isassigned(__meta_HelloReply)
            ...
            meta(target, HelloReply, allflds, ProtoBuf.DEF_REQ, ProtoBuf.DEF_FNUM, ProtoBuf.DEF_VAL, ProtoBuf.DEF_PACK, ProtoBuf.DEF_WTYPES, ProtoBuf.DEF_ONEOFS, ProtoBuf.DEF_ONEOF_NAMES)
        end
        __meta_HelloReply[]
    end
end
...
const _Greeter_desc = ServiceDescriptor("GreetingService.Greeter", 1, _Greeter_methods)
...
SayHello(stub::GreeterStub, controller::ProtoRpcController, inp::HelloRequest, done::Function) = call_method(stub.impl, _Greeter_methods[1], controller, inp, done)
SayHello(stub::GreeterBlockingStub, controller::ProtoRpcController, inp::HelloRequest) = call_method(stub.impl, _Greeter_methods[1], controller, inp)
